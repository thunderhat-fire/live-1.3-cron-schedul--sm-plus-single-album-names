...
const ItemTypeSelect: FC<ItemTypeSelectProps> = ({
  ...
  const { formatType, setFormatType } = useSearch();

  const typeOfProperty = [
    {
      name: "Vinyl",
      description: "12-inch and 7-inch vinyl records",
      checked: formatType.includes("Vinyl"),
    },
    {
      name: "Digital",
      description: "Digital album downloads",
      checked: formatType.includes("Digital"),
    },
  ];
